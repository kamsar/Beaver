...
robocopy $SourceWebDirectory $WebWorkingDirectory /XA:HS /MIR /NDL /XD .git .svn aspnet_client obj serialization temp /XF *.ai *.psd *.fla Thumbs.db *.item .gitignore /NP /R:20 2>&1 | out-host
